...
strategy'' and ``value at most $\frac12$'', together with the semidecidability of ``value
above $\frac12$'', yields the reduction. This isolates all uses of Kleene's recursion
