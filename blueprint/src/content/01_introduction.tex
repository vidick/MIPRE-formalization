...
\texttt{sorry} as the target. The abstract compression assembly and the repetition
instance are formalized. What remains is to supply introspection and answer reduction
(including its internal typed oracularization), with the paper-to-model
interfaces recorded in Section~\ref{ch:proof-structure}, remains work. The goals of this project are to (a) complete a formalization of this theorem and
