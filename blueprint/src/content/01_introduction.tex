...
$\MIPco=\coRE$~\cite{Lin23,Lin25}, first among them stating the pipeline in value form
throughout, following Lin's compressibility criterion, so that gap amplification uses
direct rather than anchored parallel repetition and Theorem~\ref{thm:bvy} is not needed
