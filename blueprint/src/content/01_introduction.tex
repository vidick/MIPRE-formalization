...
uncomputability of the game value, are proved in Lean with no hypothesis:
\texttt{HaltingGameValue.halting\_reduces\_to\_gameValue} (\texttt{MIPRE/MainTheorem.lean}) proves
the statement of \texttt{HaltingGameValue.lean}, and \texttt{\#print axioms} shows only
\texttt{propext}, \texttt{Classical.choice} and \texttt{Quot.sound}. The proof is the compression
pipeline, Theorem~\ref{thm:compression}, with its three stages supplied: introspection for
seven-level inputs, answer reduction over the classical PCP decider, and parallel repetition
(Theorem~\ref{thm:compression-target}). The goals of this project are to (a) complete a formalization of this theorem and
