...
What is not yet here: $\ket{\EPR_q}^{\ot M}$ with its stabilizer relations, and
Lemma~\texttt{lem:pauli-binary}, the isomorphism carrying the qudit system to $Lk$ qubits.
Equation~\eqref{eq:pauli-line-bp} is the identity
Lemma~\ref{lem:qld-expanded-points} averages to, at $v = \ind_m(u)$.
