...
\uses{thm:ms-rigidity,lem:self-dual-basis,thm:bvy,thm:direct-repetition-q,rem:direct-vs-anchored}
...
\begin{enumerate}
\item \textbf{Anchored parallel repetition} (node $1.4.2$, Theorem~\ref{thm:bvy}). Not used.
