...
synchronous form]
\label{thm:main}
\uses{thm:compression-target,thm:halting,def:game-description,def:sync-value,def:re}
...
\begin{proof}
\uses{thm:compression-target,thm:halting}
\leanok
...
\lean{MIPRE.Halting.halting_reduction_quantum, MIPRE.Halting.halting_reduction_quantum_of,
...
\lean{MIPRE.Halting.gameValue_uncomputable, MIPRE.Halting.quantumValue_uncomputable,
  MIPRE.Halting.gameValue_uncomputable_of, MIPRE.Halting.quantumValue_uncomputable_of}
\leanok
...
\lean{MIPRE.Halting.mipstar_eq_re, MIPRE.Halting.re_subset_mipstar,
  MIPRE.Halting.mipstar_eq_re_of, MIPRE.Halting.re_subset_mipstar_of,
