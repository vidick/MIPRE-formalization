...
proof of Theorem~\ref{thm:main} still waits on is the four open obligations of
Theorem~\ref{thm:halting}, and, within the tabulation, the record of its agreement with
$\verifier_n$ in the form the completeness bridge consumes (Remark~\ref{rem:compression-abstract}).
