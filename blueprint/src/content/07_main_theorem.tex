...
\lean{HaltingGameValue.halting_reduces_to_gameValue, MIPRE.Halting.halting_reduces_to_gameValue_of}
\leanok
...
\emph{Status.} The theorem is proved in Lean conditionally on an inhabitant of
\texttt{MIPRE.GapCompression}, the open target of Theorem~\ref{thm:compression-target}:
...
free of \texttt{sorry}; the unconditional \texttt{HaltingGameValue.halting\_reduces\_to\_gameValue}
keeps its \texttt{sorry} as the target of Chapter~\ref{ch:proof-structure}, and the
difference between the two is one structure. Theorem~\ref{thm:compression} constructs
that structure conditionally on the ambient introspection and answer-reduction contracts;
with the supplied introspection and repetition stages the only remaining hypothesis is answer
reduction (Corollary~\ref{cor:compression-from-answer-reduction}).
...
\lean{MIPRE.Halting.halting_reduction_quantum_of, MIPRE.Halting.halting_reduction_both_of}
\leanok
...
\begin{proof}
\leanok
Conditionally on the compression inhabitant of Theorem~\ref{thm:compression-target},
as Theorem~\ref{thm:main} is:
...
\lean{MIPRE.Halting.gameValue_uncomputable_of, MIPRE.Halting.quantumValue_uncomputable_of}
\leanok
...
(\texttt{Halting/Corollaries.lean}), conditionally on an inhabitant of
\texttt{MIPRE.GapCompression} (Theorem~\ref{thm:compression-target}).
\end{proof}
...
\lean{MIPRE.Halting.mipstar_eq_re_of, MIPRE.Halting.re_subset_mipstar_of,
...
Definition~\ref{def:mipstar}; the equality is conditional on the compression inhabitant
of Theorem~\ref{thm:compression-target},
as Theorem~\ref{thm:main} is; with the supplied stages, on an answer-reduction inhabitant
alone (Corollary~\ref{cor:compression-from-answer-reduction}).
\end{proof}
