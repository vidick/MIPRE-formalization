...
loss, and compression preserves ``value at most $\frac12$''. No entanglement lower bound is
tracked. Remark~\ref{rem:direct-vs-anchored} explains why none is needed,
...
Remark~\ref{rem:compression-abstract}; the semidecidability hypothesis of the lemma is
Lemma~\ref{lem:value-lower-approx}. The entanglement form of the statement, with the
