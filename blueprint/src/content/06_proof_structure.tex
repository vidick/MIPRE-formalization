...
repetition (Theorem~\ref{thm:direct-repetition-q}, formalized modulo
Lemma~\ref{lem:povm-value-eq}) restores soundness
...
(Remark~\ref{rem:sync-invariant}). The entanglement form of the statement, with the
