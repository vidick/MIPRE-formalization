...
to be. In the recursion of this lemma every level's string is the compressor's own output one
level up, so that is available; it is not among the hypotheses as stated. Recorded here and in
\texttt{planning/h4-assembly.md} rather than repaired, because the cheapest form of the extra
hypothesis is visible only once O4's construction exists.
