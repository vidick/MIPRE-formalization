...
branch tests, at every level, whether $S$ halts on $x_e$.
...
level, property 2 of $\compr$ gives $h(e, r(e), n) \in B$ at every level, in particular
...
$h(e, r(e), n) \in A$ at every level, provided the second branch never fires at a level
...
value-$1$ PCC strategy, $B$ the set of those with $\synval \leq \frac12$, and $S$ the
