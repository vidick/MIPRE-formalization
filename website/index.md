...
[arXiv:2001.04383](https://arxiv.org/abs/2001.04383)). The main theorem is
stated, self-contained on top of Mathlib, in
[`MIPRE/HaltingGameValue.lean`](https://github.com/vidick/MIPRE-formalization/blob/main/MIPRE/HaltingGameValue.lean):
...
- [Blueprint](blueprint/) — the proof plan with its dependency graph
- [Blueprint (pdf)](blueprint.pdf)
- [API documentation](docs/)
- [GitHub repository](https://github.com/vidick/MIPRE-formalization)
- [How to contribute](https://github.com/vidick/MIPRE-formalization/blob/main/CONTRIBUTING.md)
